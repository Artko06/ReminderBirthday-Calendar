...
import com.artkotlindev.domain.models.date.MonthYear
import com.artkotlindev.domain.util.extensionFunc.calculateDaysLeft
import com.artkotlindev.domain.util.extensionFunc.calculateNextAge
import com.artkotlindev.domain.util.extensionFunc.nextEvent
...
import com.artkotlindev.reminderbirthday_calendar.presentation.components.evetns.DaysLeftButton
import com.artkotlindev.reminderbirthday_calendar.presentation.components.evetns.EmptyEmoji
import com.artkotlindev.reminderbirthday_calendar.presentation.components.evetns.EventItem
import com.artkotlindev.reminderbirthday_calendar.presentation.components.evetns.MonthYearText
import com.artkotlindev.reminderbirthday_calendar.presentation.components.evetns.SearchLine
import com.artkotlindev.reminderbirthday_calendar.presentation.components.evetns.SelectorSortEventType
import com.artkotlindev.reminderbirthday_calendar.presentation.event.EventsEvent
                ...
                if (eventState.sortTypeEvent == null){
                    Button(
                        ...
                        Row(
                            ...
                            Icon(
                                painter = painterResource(R.drawable.ic_import_contacts),
